...
```
เมื่อผ่านจะแสดงข้อความ `ALL 4 TEST SUITES PASSED SUCCESSFULLY!`

### 2. ทดสอบการทำงานจริงด้วยภาพตัวอย่าง (Sample Image Testing)
หากไม่มีภาพถ่ายเอกสารจริง สามารถสร้างภาพเอกสารจำลองเพื่อนำไปทดสอบบนเว็บได้:
```bash
# 1. สร้างภาพจำลอง (ไฟล์จะถูกบันทึกไว้ที่ test_images/sample_document.png)
python test_images/generate_sample.py
# (หรือใช้ py test_images/generate_sample.py)
