...
1. **เลือกภาษา (Language):** ที่ด้านบนสุดของแถบ Sidebar สามารถเลือกสลับระหว่าง **🇹🇭 ภาษาไทย** หรือ **🇬🇧 English** ได้ตลอดเวลา
2. **อัปโหลดภาพ:** ลากและวางไฟล์ภาพถ่ายเอกสาร (รองรับ JPG, PNG, BMP, TIFF, WebP) ลงในกล่องอัปโหลด
3. **ปรับแต่งพารามิเตอร์ (แถบด้านซ้าย - Sidebar):**
...
4. **ตรวจสอบผลลัพธ์:** ดูการแสดงผลเปรียบเทียบภาพต้นฉบับกับภาพที่ถูกดัดมุมมองและปรับแต่งแล้ว พร้อมแสดงค่า Homography Matrix
5. **ดาวน์โหลดเอกสาร:** คลิกปุ่ม Download Scanned Image เพื่อบันทึกภาพผลลัพธ์
